  ...
  jQuery.autogrow.fn.extend({
    ...
    checkExpand: function() {
      ...
      if (this.dummy.html() != html)
      {
        ...
        if (this.max_height > 0 && (this.dummy.outerHeight() + this.line_height > this.min_height))
        {
        ...
        else
        {
          ...
          if (this.textarea.outerHeight() < this.dummy.height() + this.line_height || (this.dummy.outerHeight() < this.textarea.height()))
          { 
            this.textarea.animate({height: (this.dummy.outerHeight() + this.line_height) + 'px'}, 100);  
          }
        }
      }
